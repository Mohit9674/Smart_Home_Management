...
# Booking behavior (admin action -> set property unavailable)
BOOKING_SETS_UNAVAILABLE_ON_APPROVAL = True
# ADMINS = [("Admin", "muhammadadnan.py@gmail.com")]
# DEFAULT_FROM_EMAIL = "noreply@smarthomemanagement.com"
# EMAIL_BACKEND = os.getenv("EMAIL_BACKEND", "django.core.mail.backends.console.EmailBackend")



USE_LOCAL_MEDIA = os.getenv("USE_LOCAL_MEDIA", "1")  # default to local in dev

if USE_LOCAL_MEDIA == "1":
    DEFAULT_FILE_STORAGE = "django.core.files.storage.FileSystemStorage"
    MEDIA_URL = "/media/"
    MEDIA_ROOT = BASE_DIR / "media"

    # Who receives mail_admins()
ADMINS = [
    ("You", "muhammadadnan.py@gmail.com"),
]

# Use SMTP (Gmail example)
EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
EMAIL_HOST = "smtp.gmail.com"
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "muhammadadnan.py@gmail.com"   # your Gmail address
EMAIL_HOST_PASSWORD = "mxlkrvnfhyyqzdvd"  # set as env var

# From address
DEFAULT_FROM_EMAIL = "SmartHome <muhammadadnan.py@gmail.com>"
SERVER_EMAIL = DEFAULT_FROM_EMAIL
EMAIL_SUBJECT_PREFIX = "[Smart Home Management] "
